...
const LS={line:252,lineRule:LineRuleType.AUTO};

// numbered clause item: "1.1." + text runs
const item=(n,runs,o={})=>new Paragraph({
  spacing:{...LS,before:o.before||0,after:o.after===undefined?118:o.after},
...
const sec=(n,t)=>new Paragraph({
  spacing:{...LS,before:205,after:118}, keepNext:true,
...
const doc = new Document({
  ...
  sections:[{
    properties:{page:{size:{width:12240,height:15840},margin:{top:1000,right:1220,bottom:780,left:1220,footer:370}}},
    footers:{default:new Footer({children:[
      new Paragraph({spacing:{after:0},border:{top:{style:BorderStyle.SINGLE,size:6,color:"AAAAAA",space:6}},children:[
        new TextRun({text:"Minuta de trabalho, versão 4.0. Não constitui parecer jurídico; sujeita à revisão do advogado da família e de tributarista antes da assinatura.",font:F,size:16,color:MUT,italics:true})]})]})},
    children:[
    ...
    item("2.1.",[["Integram o Perímetro as obrigações pecuniárias, vencidas ou vincendas, originadas nos negócios conduzidos ou liderados por Wilson Grison, "],["independentemente da pessoa em cujo nome tenham sido contraídas",{bold:true}],[": financiamentos e empréstimos bancários, dívidas com fornecedores e prestadores de serviço, tributos de qualquer esfera, multas e autos de infração, custas e emolumentos cartorários, parcelamentos e obrigações decorrentes de garantias prestadas."]]),
    item("2.2.",[["Alcança as dívidas da Grison e Cia Ltda., as pessoais de Wilson e de Elman M. Coelho Grison como devedores, avalistas, fiadores ou coobrigados, e as das sociedades por eles constituídas, controladas ou dirigidas de fato, ainda que em nome de filhos, cônjuge ou terceiros — EMC Grison, Bioaçaí, ML Serviços Agrícolas, Natyrê, Tiúba 2 SPE e Patrimônio Digital. Obrigação não relacionada no Anexo II que se enquadre nesta definição integra o Perímetro."]]),
    ...
    item("2.4.",[["Não integra o Perímetro o adiantamento do loteador parceiro (Santa Helena), recomposto por retenção, pelo próprio loteador, dos repasses devidos ao grupo: sua liquidação é automática e independe de ato de gestão dos sócios."]]),
    item("2.5.",[["Dívida Quitada é aquela cujo saldo é zero e cuja exigibilidade se extinguiu perante todos os coobrigados, por pagamento, deságio, transação, novação, decisão transitada em julgado, prescrição ou assunção liberatória com exoneração dos garantidores. É indiferente o valor desembolsado. "],["Parcelamento em curso não é Dívida Quitada, ressalvado o item 2.6.",{bold:true}]]),
    item("2.6.",[["Dívidas Fiscais Parceladas. ",{bold:true}],["Não precisam ser quitadas à vista, nem impedem o cumprimento da Meta I, as obrigações perante a Receita Federal, inclusive imposto de renda, a Receita Estadual, a Receita Municipal e o Tribunal de Contas da União submetidas a parcelamento ou transação regularmente deferidos, adimplentes e sem garantia pessoal de Sócio Sujeito à Retenção. A perda da adimplência restabelece a trava do item 5 até a regularização."]]),
    ...
    item("(c)",[["Meta III — Imóvel da usufrutuária. ",{bold:true}],["Disponibilidade, em reserva vinculada, do montante bruto apurado na forma do item 4.3, correspondente a R$ 1.876.046,901 para imóvel mobiliado de R$ 1.400.000,00 — ou operação já concluída."]],{indent:{left:420}}),
    item("3.2.",[["A Meta I somente se tem por cumprida mediante, cumulativamente: certidões negativas, ou positivas com efeito de negativas, federais, estaduais e municipais das pessoas do Perímetro; ausência de protesto; ausência de anotação restritiva em Serasa, SPC ou equivalente; e baixa dos gravames. Anotação decorrente de dívida particular de sócio não impede o cumprimento da Meta."]]),
    ...
    item("4.2.",[["O custo econômico da aquisição recai exclusivamente sobre Leonardo e Bárbara Grison, filhos biológicos e herdeiros da usufrutuária. Wellington e Marcelo Grison não concorrem para esse custeio e recebem em dinheiro o correspondente à sua participação no montante bruto."]]),
    item("4.3.",[["Fórmula. ",{bold:true}],["O montante bruto da operação corresponde ao valor do imóvel mobiliado dividido por 74,625%, soma das participações de Leonardo (37,3125%) e Bárbara (37,3125%) na qualidade de herdeiros da usufrutuária."]]),
    new Paragraph({spacing:{...LS,after:170},alignment:AlignmentType.CENTER,children:[
      new TextRun({text:"Montante Bruto  =  Valor do Imóvel Mobiliado  ÷  74,625%",font:F,size:22,bold:true,color:INK})]}),
    item("4.4.",[["Apurado o montante bruto, a operação se decompõe em:"]],{after:110}),
    item("(a)",[["parcela satisfeita em bem",{bold:true}],[" — 37,3125% a Bárbara Grison e 37,3125% a Leonardo Grison, integralmente aplicados na aquisição do imóvel;"]],{indent:{left:420},after:90}),
    item("(b)",[["parcelas em dinheiro",{bold:true}],[" — 12,4375% a Wellington Grison e 12,4375% a Marcelo Grison;"]],{indent:{left:420},after:90}),
    item("(c)",[["parcela em dinheiro",{bold:true}],[" — 0,500% a Leonardo Grison."]],{indent:{left:420}}),
    item("4.5.",[["A participação de 0,500% de Leonardo Grison na Grison e Cia Ltda. é anterior à reorganização societária e não decorre de herança. Seu produto é pago em dinheiro e "],["não integra o custeio do imóvel",{bold:true}],["."]]),
    item("4.6.",[["Os percentuais e valores deste item são expressos com três casas decimais e arredondados ao centavo no momento do pagamento."]]),
    item("4.7.",[["A aquisição do imóvel e os pagamentos em dinheiro são simultâneos, constituem execução da Meta III e não configuram distribuição vedada pelo item 5."]]),
    item("4.8.",[["Os percentuais deste item aplicam-se exclusivamente a esta operação e não estabelecem critério de rateio para as demais distribuições."]]),
    item("4.9.",[["O enquadramento tributário da aquisição e da transferência ao patrimônio da usufrutuária será definido previamente com o tributarista, e seu custo integra o montante bruto."]]),
    item("4.10.",[["Aplicação da fórmula a imóvel mobiliado de R$ 1.400.000,00, a título ilustrativo:"]],{after:130}),

    new Table({columnWidths:TW,rows:[
      row("Sócio","Participação","Valor (R$)",{bold:true,head:true}),
      row("Bárbara Grison","37,3125% — em bem","700.000,000"),
      row("Leonardo Grison","37,3125% — em bem","700.000,000"),
      row("Wellington Grison","12,4375% — em dinheiro","233.333,333"),
      row("Marcelo Grison","12,4375% — em dinheiro","233.333,333"),
      row("Leonardo Grison","0,500% — em dinheiro","9.380,235"),
      row("Montante bruto","100,000%","1.876.046,901",{bold:true}),
    ]}),
    ...
    item("5.3.",[["Os lucros que lhes caberiam são destinados a reserva fundamentada em orçamento de capital aprovado anualmente em Assembleia (art. 196 da Lei 6.404/76), obrigando-se eles a votar favoravelmente a essa destinação. O Estatuto fixará o dividendo obrigatório em percentual compatível com este Anexo (art. 202)."]]),

    // ---- 6 ----
    sec("6.","Exceções"),
    item("6.1.",[["Não configuram distribuição vedada: (a) as parcelas do ITCMD da doação e os custos dos atos societários e registrais correlatos; (b) o pró-labore, em valor de mercado aprovado em Assembleia, dos sócios que exerçam função na Companhia ou em controladas; (c) o reembolso de despesas comprovadas no interesse da Companhia; (d) a devolução de mútuo formalizado com juros de mercado e encargos recolhidos."]]),
    ...
    item("7.1.",[["A administração apresentará relatório semestral de progresso. Entendendo as Metas cumpridas, convocará Assembleia instruída com balancete de até 30 dias, declaração do contador, comprovação da extinção de cada obrigação e as certidões do item 3.2."]]),
